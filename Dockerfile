...
# Step 9: Increase spawn timeout
RUN echo "c.NotebookApp.shutdown_no_activity_timeout = 600" >> /home/jovyan/.jupyter/jupyter_notebook_config.py && \
...
# Step 10: Run Jupyter Notebook with detailed logging
